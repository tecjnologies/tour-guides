            ...
            <div class="col-md-12">
                ...
                <div class="card m-4">
                    <div class="card-header bg-dark">
                        ...
                        <a href="{{ route('admin.tourtype.create') }}" class="btn btn-success btn-md float-right c-white">Add
                    ...
                    @if ($types->count() > 0)
                        <div class="card-body">
                                        ...
                                        @foreach ($types as $key => $type)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.tourtype.edit', $type->id) }}"
                                                        class="btn btn-info">Edit</a>
                                                    <button type="submit" onclick="handleDeleteType({{ $type->id }})"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="deleteTypeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                    ...
                                    <form action="" id="deleteTypeForm" method="POST">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"> Tour  Type </h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center">Are you sure to delete this Tour type?</div>
                                            </div>
