      ...
      <select class="border rounded">
        ...
        {{-- <div class="language d-flex justify-content-start align-items-center me-4">
            ...
            <select class="border rounded" onchange="location = this.value;">
                <option value="{{ route('language.switch', 'en') }}" class="font-5 display-16 color-blue"
                    {{ Session::get('locale') === 'en' ? 'selected' : '' }}>{{ __('website.TOPBAR.ENGLISH') }}</option>
                <option value="{{ route('language.switch', 'ar') }}" class="font-5 display-16 color-blue"
        ...
        <div class="currency d-flex justify-content-start align-items-center me-2">
            ...
            <select class="border rounded" id="currency-select">
                <option value="USD" class="font-5 display-16 color-blue"
                    {{ session('currency') === 'USD' ? 'selected' : '' }}>USD</option>
                <option value="AED" class="font-5 display-16 color-blue"
                    {{ session('currency') === 'AED' ? 'selected' : '' }}>AED</option>
            </select>
        </div>
    </div>
</div>
